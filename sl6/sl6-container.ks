...
rpm -e --nodeps kernel
yum -y remove bc busybox dash dbus-glib dc dracut-kernel dracut e2fsprogs e2fsprogs-libs efibootmg elfutils-libs fipschec* grubby grub hwdata kbd-misc kbd kdump  kernel-firmware logrotate libcap-ng libpciaccess libss m4 mailx mysql-libs pciutils-libs selinux-policy selinux-policy-targeted sl-logos sudo sysvinit-tools tcp_wrappe* redhat-logos upstart xfsprogs
